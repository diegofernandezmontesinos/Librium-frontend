      ...
      <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center md:items-start space-y-6 md:space-y-0">
          ...
          <div className="text-center md:text-right">
            <h3 className="text-lg font-bold text-lavanda-400">OnlineLibrary</h3>
        ...
        <div className="mt-8 pt-4 border-t border-gray-700 text-center text-xs text-gray-600">
            <p>
                Este sitio es un proyecto de demostración. Diseñado para una experiencia literaria disruptiva.
            </p>
        </div>
      </div>
    </footer>
